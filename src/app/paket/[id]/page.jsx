            ...
            <div className="bg-white rounded-2xl shadow-sm border border-neutral-100 p-4 md:p-5">
              ...
              <div className="flex flex-col gap-3">
                <Link 
                  ...
                  className="bg-amber-400 hover:bg-amber-500 text-neutral-900 w-full py-3.5 rounded-xl font-bold flex items-center justify-center transition-colors text-sm shadow-sm"
                ...
                <a 
                  ...
                  className="bg-white border-2 border-[#25D366] hover:bg-[#25D366]/5 text-[#25D366] w-full py-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-colors text-sm"
                >
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-neutral-200 px-4 py-3 shadow-[0_-4px_10px_rgba(0,0,0,0.02)] z-50 md:hidden">
        <div className="container mx-auto flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <Link 
              href={`/paket/${resolvedParams.id}/book`}
              className="bg-amber-400 text-neutral-900 px-5 py-2.5 rounded-md font-semibold flex items-center justify-center transition-colors text-sm whitespace-nowrap shadow-sm"
              style={{ backgroundColor: brandColor, color: '#fff' }}
            >
              Booking
            </Link>
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white border-2 border-[#25D366] text-[#25D366] p-2 rounded-md flex items-center justify-center transition-colors"

...
export default function BrandNotFoundPage() {
  return (
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-sm border border-neutral-200 p-6 sm:p-8 text-center">
        ...
        <h1 className="text-xl sm:text-2xl font-bold text-neutral-800 mb-2">Situs Tidak Ditemukan</h1>

...
export default function Badge({ variant = 'draft', icon, showIcon = true, children, className = '' }) {
  const variants = {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[11px] font-semibold tracking-wide ${selectedVariant} ${className}`}
    >
      {showIcon && badgeIcon}
      <span>{children}</span>
    </span>

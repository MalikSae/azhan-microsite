...
export default function PackageListClient({
  initialSchedules = [],
  brandWhatsapp = '',
  brandName = '',
  brandLogoUrl = '',
  ...
  const filteredAndSortedSchedules = useMemo(() => {
    ...
    return result;
  }, [initialSchedules, searchQuery, sortBy, showControls]);

  return (
    <div className="space-y-6">
      {/* Search & Filter Control Bar (Hanya jika showControls=true) */}
      {showControls && (
        <>
          ...
          {/* Result Count */}
          <div className="flex justify-between items-center gap-2 text-xs sm:text-sm text-neutral-500 font-medium px-1">
